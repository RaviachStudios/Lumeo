@echo off
echo ========================================
echo LevelPlay Plugin Build Script
echo ========================================
echo.
...
echo.
echo Copying AARs into addons\GodotLevelPlay\bin ...

if not exist "..\addons\GodotLevelPlay\bin\debug"   mkdir "..\addons\GodotLevelPlay\bin\debug"
if not exist "..\addons\GodotLevelPlay\bin\release" mkdir "..\addons\GodotLevelPlay\bin\release"

copy /Y "build\outputs\aar\GodotLevelPlay-debug.aar"   "..\addons\GodotLevelPlay\bin\debug\GodotLevelPlay-debug.aar"
copy /Y "build\outputs\aar\GodotLevelPlay-release.aar" "..\addons\GodotLevelPlay\bin\release\GodotLevelPlay-release.aar"
